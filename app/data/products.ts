...
export const products: Product[] = [
  {
    ...
    shortDescription: 'Precision-engineered alloy wheel for 5×120 applications. Five-spoke architecture with motorsport-grade geometry.',
    description: 'The Victoria is the first commercial wheel from SAMORAI — a statement of what precision engineering looks like when driven by a passion for automotive performance. Engineered around 5×120 PCD with a 72.6mm center bore, the Victoria delivers exact OEM tolerances with an aesthetic that elevates any build. Available in three finishes: Anthracite Grey, Black Metallic, and Silver Metallic. Compatible with a wide range of 5×120 vehicles — use custom hub rings for non-72.6 center bore applications.',
    ...
    variants: [
      /* — Anthracite Grey — */
      {
        ...
        color: 'Anthracite Grey', vehicleFitment: ['5×120 / CB72.6 applications', 'E.g. 3-series, 4-series platforms'],
      ...
      },
      {
        ...
        color: 'Anthracite Grey', vehicleFitment: ['5×120 / CB72.6 applications', 'E.g. 3-series, 5-series platforms'],
        maxLoad: 650, capLogo: 'SAMORAI Logo', stockStatus: 'in_stock', priceLabel: 'Price on request',
      },
      {
        id: 'vic-18x9-et45-ag',
        diameter: 18, width: 9, et: 45, pcd: '5x120', cb: 72.6,
        color: 'Anthracite Grey', vehicleFitment: ['5×120 / CB72.6 applications', 'E.g. 5-series, 6-series platforms'],
      ...
      },
      {
        ...
        color: 'Anthracite Grey', vehicleFitment: ['5×120 / CB72.6 applications', 'E.g. 5-series, M-platform'],
      ...
      /* — Black Metallic — */
      {
        ...
        diameter: 18, width: 8.5, et: 35, pcd: '5x120', cb: 72.6,
        color: 'Black Metallic', vehicleFitment: ['5×120 / CB72.6 applications', 'E.g. 3-series, 4-series platforms'],
        maxLoad: 650, capLogo: 'SAMORAI Logo', stockStatus: 'in_stock', priceLabel: 'Price on request',
      },
      {
        id: 'vic-18x9-et35-bm',
        diameter: 18, width: 9, et: 35, pcd: '5x120', cb: 72.6,
        color: 'Black Metallic', vehicleFitment: ['5×120 / CB72.6 applications', 'E.g. 3-series, 5-series platforms'],
        maxLoad: 650, capLogo: 'SAMORAI Logo', stockStatus: 'in_stock', priceLabel: 'Price on request',
      },
      {
        id: 'vic-18x9-et45-bm',
        diameter: 18, width: 9, et: 45, pcd: '5x120', cb: 72.6,
        color: 'Black Metallic', vehicleFitment: ['5×120 / CB72.6 applications', 'E.g. 5-series, 6-series platforms'],
        maxLoad: 650, capLogo: 'SAMORAI Logo', stockStatus: 'in_stock', priceLabel: 'Price on request',
      },
      {
        id: 'vic-18x95-et45-bm',
        diameter: 18, width: 9.5, et: 45, pcd: '5x120', cb: 72.6,
        color: 'Black Metallic', vehicleFitment: ['5×120 / CB72.6 applications', 'E.g. 5-series, M-platform'],
      ...
      /* — Silver Metallic — */
      {
        ...
        color: 'Silver Metallic', vehicleFitment: ['5×120 / CB72.6 applications'],
        maxLoad: 650, capLogo: 'SAMORAI Logo', stockStatus: 'in_stock', priceLabel: 'Price on request',
      },
      {
        id: 'vic-18x9-et35-sm',
        diameter: 18, width: 9, et: 35, pcd: '5x120', cb: 72.6,
        color: 'Silver Metallic', vehicleFitment: ['5×120 / CB72.6 applications', 'E.g. 3-series, 5-series platforms'],
        maxLoad: 650, capLogo: 'SAMORAI Logo', stockStatus: 'low_stock', priceLabel: 'Price on request',
      },
